...
output connectionString string = listKeys(resourceId('Microsoft.ServiceBus/namespaces/AuthorizationRules','${serviceBusNamespace.name}','RootManageSharedAccessKey'),'2017-04-01').primaryConnectionString
